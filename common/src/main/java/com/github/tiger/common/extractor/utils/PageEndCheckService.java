...
public class PageEndCheckService {
    ...
    private FetchConfigDao fetchConfigDao = new FetchConfigDao();
    ...
    public void check(int siteId, PageEndCheckCommand command) {
        ...
        for (FetchConfigEntity entity : fetchConfigEntityList) {
            ...
            entity.setPagingRules(pagingRules);
            updateFetchConfigEntity(entity);

        }
    }

    public boolean updateFetchConfigEntity(FetchConfigEntity entity) {
        return fetchConfigDao.update(entity);
    }

    public List<FetchConfigEntity> getFetchConfigEntitys(int siteId) {
        return fetchConfigDao.getList(siteId);
    }
